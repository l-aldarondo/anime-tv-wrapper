...
object CatalogRepository {
    ...
    suspend fun loadHomeContent(forceRefresh: Boolean = false): HomeCatalogData = coroutineScope {
        if (!forceRefresh && cachedLatinoTrending.isNotEmpty() && cachedJKRecent.isNotEmpty()) {
